...
def build_basemap_snapshot_png(lats, lons, title: str = None, point_labels=None) -> bytes:
    ...
    try:
        ...
        for i, (lat, lon) in enumerate(zip(lats, lons)):
            ...
            r = 6
            draw.ellipse([x - r, y - r, x + r, y + r], fill="#00B4C0", outline="white", width=2)
...
with head_col1:
    ...
    <div class="top-banner">
      ...
      <div>
        ...
        <p class="s">{COMPANY_NAME} &middot; Vijayawada Field Ops</p>
      </div>
    </div>
    """, unsafe_allow_html=True)
with head_col2:
...
def build_weekly_report_pdf(date_start, date_end, section_filter=None, meter_type_filter: str = "All"):
    ...
    # Footer rule + company line, pinned to the bottom of the page.
    footer_y = pdf.h - pdf.b_margin - 6
    pdf.set_draw_color(220, 224, 230)
    pdf.line(pdf.l_margin, footer_y, pdf.w - pdf.r_margin, footer_y)
    pdf.set_xy(pdf.l_margin, footer_y + 1)
    pdf.set_font("Helvetica", "", 7.5)
